...
class Gestionstockv1clientsService extends __BaseService {
  static readonly findAllPath = '/gestionstock/v1/clients/all';
  static readonly savePath = '/gestionstock/v1/clients/create';
  static readonly deletePath = '/gestionstock/v1/clients/delete/{idClient}';
  static readonly findByIdPath = '/gestionstock/v1/clients/{idClient}';
  ...
  findAllResponse(): __Observable<__StrictHttpResponse<Array<ClientDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestionstock/v1/clients/all`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  saveResponse(body?: ClientDto): __Observable<__StrictHttpResponse<ClientDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestionstock/v1/clients/create`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idClient: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/gestionstock/v1/clients/delete/${idClient}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByIdResponse(idClient: number): __Observable<__StrictHttpResponse<ClientDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestionstock/v1/clients/${idClient}`,
      __body,
      {
        headers: __headers,
        params: __params,
...
module Gestionstockv1clientsService {
}

export { Gestionstockv1clientsService }
